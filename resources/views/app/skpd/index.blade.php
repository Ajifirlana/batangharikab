                            ...
                            <div class="card-header">
                                <h3 class="card-title">
                                    <a href="#" class="btn btn-sm btn-primary" id="btn_tambah"><i
                                            class="fas fa-plus"></i> Tambah SKPD</a>
                                </h3>
                            </div>
                            <div class="card-body">
            ...
            FilePond.registerPlugin(
                ...
                const inputElement = document.querySelector('input[type="file"]');
                 const pond = FilePond.create(inputElement,{
                    ...
                    imageCropAspectRatio: '1:1',    // Atur rasio aspek menjadi 1:1 (270x270)
                    allowImageCrop: true,           // Izinkan cropping
                    stylePanelAspectRatio: 1,       // Panel juga mengikuti rasio 1:1
                    imageResizeTargetWidth: 100,    // Lebar target resize
                    imageResizeTargetHeight: 100,   // Tinggi target resize
            ...
            $('#datatable').on('click', '.btn_edit', function(e) {
              ...
              //  const file_cover = FilePond.create(document.querySelector('#file'));
                $.get(url, function(response) {
                    ...
                    $('#id_skpd').val(response.data.id)
                    $('#ket').val(response.data.keterangan)
